...
exports.smsg = (conn, m, store) => {
    ...
    if (m.message) {
        ...
        m.msg = (m.mtype == 'viewOnceMessage' ? m.message[m.mtype].message[getTypeMessage(m.message[m.mtype].message)] : m.message[m.mtype].message ? m.message[m.mtype].message[getTypeMessage(m.message[m.mtype].message)] : m.message[m.mtype])
    ...
    conn.appenTextMessage = async (text, chatUpdate) => {
        ...
        await conn.ev.emit('messages.upsert', msg)
    }
